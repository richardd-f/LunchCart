      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            {/* Mobile Cart Icon */}
            {session?.user && (
              <Link href="/cart" className="md:hidden flex items-center hover:text-amber-100 transition-colors">
        ...
        <div className="border-t border-white/10 bg-[#F97352] px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          {navInfo.hasShopRole && (
            <div className="space-y-1">
              <button
                ...
                className="flex w-full items-center justify-between px-3 py-2 rounded-md text-base font-medium hover:bg-white/10 transition-colors text-left"
              >
                <span>Shop</span>
                <svg 
              ...
              <div 
                className={`overflow-hidden transition-all duration-200 ease-in-out ${
                  mobileShopOpen ? 'max-h-48 opacity-100' : 'max-h-0 opacity-0'
                }`}
              >
                <Link 
                  href="/shopOrders" 
          ...
          {session?.user?.role === 'ADMIN' && (
            <div className="space-y-1">
              ...
              <div 
                className={`overflow-hidden transition-all duration-200 ease-in-out ${
                  mobileAdminOpen ? 'max-h-48 opacity-100' : 'max-h-0 opacity-0'
                }`}
              >
                <Link 
                  href="/admin/withdraw" 
