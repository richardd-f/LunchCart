      ...
      <Reveal immediate y={16} className="w-full max-w-md">
        <div className="rounded-3xl border border-white/60 bg-white/80 p-8 shadow-xl shadow-orange-100/50 backdrop-blur-xl">
          ...
          >
            <button
              type="submit"
              className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 font-medium text-gray-700 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-gray-300 hover:shadow-md"
            >
          ...
          <div className="mt-4 text-center">
            <Link
              href="/"
              className="text-sm font-medium text-[#F97352] transition-colors duration-200 hover:text-[#e86341]"
            >
              ← Kembali ke Beranda
            </Link>
          </div>
